    ...
    <div className="popularGroup">
      <div className="popularWrap">
        ...
        <BottomNavigation
          ...
          style={{width : '320px'}}
        >
          <BottomNavigationAction onClick={getMoviePopular} label="Streaming" icon={<MovieIcon/>} />
          <BottomNavigationAction onClick={getTvPopular} label="On Tv" icon={<LiveTvIcon/>} />
          <BottomNavigationAction onClick={getMoviePopularInTheater}label="In Theaters" icon={<TheatersIcon />} />
        </BottomNavigation>
      </div>
    </div>
  )
